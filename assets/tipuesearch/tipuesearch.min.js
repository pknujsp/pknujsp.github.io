            ...
            $(this).keyup(function (event) {
                ...
                if (d.length >= set.minimumLength) {
                    ...
                    if (c != 0) {
                        ...
                        if (set.showTime) { var endTimer = new Date().getTime(); var time = (endTimer - startTimer) / 1000; out += ' (' + tipuesearch_string_16 + ' : ' + time.toFixed(2) + ' ' + tipuesearch_string_14 + ')'; set.showTime = false; }
